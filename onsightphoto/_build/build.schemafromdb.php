...
$package_name = 'popupstudio';
 
 
// Database Login Info can be set explicitly:
$database_server = 'localhost';          // most frequently, your database resides locally
$dbase = 'onsightp_dev';           // name of your database
$database_user = 'root';           // name of the user
$database_password = 'p@$$w0rd';   // password for that database user
...
$package_dir = OSP_CORE_PATH . "components/$package_name/";
$model_dir = OSP_CORE_PATH . "components/$package_name/model/";
$class_dir = OSP_CORE_PATH . "components/$package_name/model/$package_name";
$schema_dir = OSP_CORE_PATH . "components/$package_name/model/schema";
$mysql_class_dir = OSP_CORE_PATH . "components/$package_name/model/$package_name/mysql";
$xml_schema_file = OSP_CORE_PATH . "components/$package_name/model/schema/$package_name.mysql.schema.xml";
